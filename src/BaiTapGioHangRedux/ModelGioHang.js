...
import { thayDoiSoLuongAction } from "./redux/action/gioiHangAction";
...
const mapDispatchToProps = (dispatch) => {
  return {
    hangleThayDoiSoLuong: (id) => {
      dispatch(thayDoiSoLuongAction(id));
    },
  };
};

export default connect(mapStateToProps, mapDispatchToProps)(ModelGioHang);
